...
public class FilterCompiler {
	...
	private RendererTemplate compileRenderer(BasePrimitiveRenderer renderer, LongLongKey id, GeContext context) {
		...
		variables.put("texTranslateX", context.tex_translate_x);
		variables.put("texTranslateY", context.tex_translate_y);
		variables.put("texScaleX", context.tex_scale_x);
		variables.put("texScaleY", context.tex_scale_y);
